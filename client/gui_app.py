...
from model.mensaje import Valores_alerta,enviar_datos
...
class Frame(tk.Frame):
    ...
    def label_varios(self):
        ...
        value_valor = tk.StringVar()
        value_valor.set("Select an Option")
    
        self.option_valor = tk.OptionMenu(self, value_valor, *options_list)
        ...
        value_rsi = tk.StringVar()
        value_rsi.set("Select an Option")

        self.option_rsi = tk.OptionMenu(self, value_rsi, *options_list)
        ...
        value_macd = tk.StringVar()
        value_macd.set("Select an Option")

        self.option_macd = tk.OptionMenu(self, value_macd, *options_list)
